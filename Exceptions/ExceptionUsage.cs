...
public class ExceptionUsage
{
    ...
    /*public void Template1()
    {
        ...
        {
            Console.WriteLine("Произошла ошибка - почини");  //написали, что вывести вместо классического исключения
        }
    }*/
 ...
 public void ShortForm1()
    ...
    {
        int result = x / y; //здесь прекратилась обработка метода
        Console.WriteLine($"Результат: {result}"); //эту часть уже не вывели
    }
