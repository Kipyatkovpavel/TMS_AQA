    ...
    class Program
    {
            ...
            
        {
            /*
              ...
              int CalculateSum(params int[] numbers)  //массив параметров. ключевое слово params, массив, который будет содержать аргументы
              {
                  int sum = 0;
              ...
              {
                  int ans = x + y; //внутри метода не x y не модифицируемые, т.к. используются как параметры в методе
              ...
              int mult = OutAdd(90, 90, out int ans1);
              ...
              int ans;
              OutAdd(90, 90, out ans); // - Первый вариант
              Console.WriteLine("OutAdd: 90 + 90 = {0}", ans);
              Console.WriteLine("OutAdd: 90 + 90 = {0}", ans1);
              Console.WriteLine("OutAdd: 90 + 90 = {0}", mult); //добавлен пример по запросу Жени по поводу добавления еще одной операции после ретурна;
              ...
              Console.WriteLine($"mainValue new is {mainValue}");
              ...
              (string, int) GetPersonInfo()  //кортеж
              {
                  return ("John", 25);
              }
              ...
              // -=================== Сжатый метод
              int ShortAdd(int х, int у) => х + у;  //без тела, одностроковая запись
